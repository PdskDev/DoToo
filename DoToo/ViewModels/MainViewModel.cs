...
namespace DoToo.ViewModels
{
    public class MainViewModel: ViewModel
    {
        ...
        public void ItemStatusChanged(object sender, EventArgs e)
        {
        ...
        public async Task NavigateToItem(TodoItemViewModel item)
        {
            if (item == null)
            {
                return;
        ...
        public string FilterText => ShowAll ? "Tout" : "Actifs";
